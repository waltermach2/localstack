...
class ReflectionStateLocator:
    ...
    def accept(self, visitor: StateVisitor):
        ...
        is_ext: bool = api_key_configured()
        base_module = "localstack_ext" if is_ext else "localstack"
        attribute_name = f"{service}_stores"
        module_name = f"{base_module}.services.{service}.models"
